...
const SERVER_SETTINGS = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'ticketLogChannelId', name: 'Canal de Transcrições/Logs (ID)', type: 'text', placeholder: 'ID do canal onde os logs de tickets são salvos' }
    ]
  },
  {
...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .hero p {
      font-size: 1.15rem; color: #b3a7c6; max-width: 800px;
