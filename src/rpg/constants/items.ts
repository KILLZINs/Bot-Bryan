...
export interface ItemStats {
  ...
  critBonus?: number; dodgeBonus?: number; goldBonus?: number;
  maxHp?: number; // ALIAS ADICIONADO PARA O NOVO COMBATE
}
...
export interface RpgItem {
  ...
  description: string;
  slot: ItemSlot;
  type?: ItemSlot;         // ALIAS ADICIONADO
  rarity: ItemRarity;
  minLevel: number;
  stats: ItemStats;
  price: number;           // preço na loja (0 = não vendável)
  buyPrice?: number;       // ALIAS ADICIONADO
  sellPrice: number;       // preço de venda
  maxStack: number;        // 1 = não stackável (equipamento)
  classRestriction?: string[]; // IDs de classes que podem usar
  effect?: string;         // efeito especial em texto
  craftable?: boolean;
}

export type Item = RpgItem; // ALIAS PARA A LOJA E FORJA NOVAS
...
for (const item of ITEM_LIST) {
  ...
  // Garante que o sistema de combate novo consiga ler a cura das poções
...
export interface CraftRecipe {
  ...
  craftTimeMin: number;  // tempo em minutos
  minLevel: number;
  costGold: number;      // 👈 ADICIONADO PARA A FORJA NOVA
  resultItemId?: string; // 👈 ALIAS
  resultQty?: number;    // 👈 ALIAS
}
...
export const CRAFT_RECIPES: CraftRecipe[] = [
  {
    ...
    craftTimeMin: 10, minLevel: 3, costGold: 100, // Preço adicionado
  },
  {
    id: 'craft_espada_aco',
    ...
    craftTimeMin: 30, minLevel: 8, costGold: 400, // Preço adicionado
  },
  {
    ...
    craftTimeMin: 5, minLevel: 1, costGold: 50, // Preço adicionado
  },
  {
    ...
    craftTimeMin: 15, minLevel: 5, costGold: 150, // Preço adicionado
  },
  {
    ...
    craftTimeMin: 8, minLevel: 3, costGold: 120, // Preço adicionado
  },
  {
    ...
    craftTimeMin: 12, minLevel: 3, costGold: 180, // Preço adicionado
  },
];
